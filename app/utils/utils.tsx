...
const speakInSul = ({
  ...
  const sound = new Howl({
    ...
    sprite: {
      ...
      ag: [50.53 * 1000, 0.326 * 1000],
      eg: [50.95 * 1000, 0.315 * 1000],
      ig: [51.37 * 1000, 0.307 * 1000],
      og: [51.82 * 1000, 0.265 * 1000],
      ug: [52.2 * 1000, 0.249 * 1000],
      ga: [52.59 * 1000, 0.348 * 1000],
      ge: [53.04 * 1000, 0.371 * 1000],
      gi: [53.52 * 1000, 0.328 * 1000],
      go: [53.93 * 1000, 0.378 * 1000],
      gu: [54.41 * 1000, 0.341 * 1000],
      gr: [54.84 * 1000, 0.336 * 1000],
      gm: [55.27 * 1000, 0.305 * 1000],
      gb: [55.66 * 1000, 0.232 * 1000],
      g: [56.149 * 1000, 0.238 * 1000],
    },
    onend: () =>
      speakInSul({
